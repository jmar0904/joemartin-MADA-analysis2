...
Figure \@ref(fig:resultfigure1) shows a scatterplot figure for the overall age category.

```{r resultfigure1,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/resultfigure1.png")
```

Figure \@ref(fig:resultfigure2) shows a scatterplot figure for the infant age category.

```{r resultfigure2,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/resultfigure2.png")
```

Figure \@ref(fig:resultfigure3) shows a scatterplot figure for the adult age category.

```{r resultfigure3,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/resultfigure3.png")
```

Figure \@ref(fig:resultfigure4) shows a scatterplot figure for the older adults age category.
...
Example table \@ref(tab:resulttable1) shows a table summarizing a linear model fit for the overall age category.

```{r resulttable1,  echo=FALSE}
resulttable1=readRDS("../../results/resulttable_overall.rds")
knitr::kable(resulttable1, caption = 'Linear model fit table.')
```

Example table \@ref(tab:resulttable2) shows a table summarizing a linear model fit for the infant early onset age category.

```{r resulttable2,  echo=FALSE}
resulttable2=readRDS("../../results/resulttable_infants.rds")
knitr::kable(resulttable2, caption = 'Linear model fit table for Infants.')
```

Example table \@ref(tab:resulttable3) shows a table summarizing a linear model fit for the adult age category.

```{r resulttable3,  echo=FALSE}
resulttable3=readRDS("../../results/resulttable_adults.rds")
knitr::kable(resulttable3, caption = 'Linear model fit table for Adults.')
```

Example table \@ref(tab:resulttable4) shows a table summarizing a linear model fit for the older adult age category.

```{r resulttable4,  echo=FALSE}
resulttable4=readRDS("../../results/resulttable_olderadults.rds")
knitr::kable(resulttable4, caption = 'Linear model fit table for Older Adults.')
```
